                    ...
                    if isinstance(block, ops.SelfAttention):
                        ...
                        try:
                            ...
                            if "contiguous" in str(e):
                                act = act.contiguous() if hasattr(act, 'contiguous') else act
                                affines[counter] = affines[counter].contiguous() if hasattr(affines[counter], 'contiguous') else affines[counter]
                                act = block(act, affines[counter])
                            else:
                                raise e                        
                        counter += 1

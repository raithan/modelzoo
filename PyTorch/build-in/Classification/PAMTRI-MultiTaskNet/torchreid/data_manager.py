...
class DatasetManager(object):
    ...
    def __init__(self, dataset_dir, root='data', verbose=True):
        ...
        train, num_train_vids, num_train_vcolors, num_train_vtypes, num_train_imgs, vcolor2label_train, vtype2label_train = self._process_dir(self.train_img_dir, self.train_heatmap_dir, self.train_segment_dir, self.train_label, relabel=True)
        query, num_query_vids, num_query_vcolors, num_query_vtypes, num_query_imgs, vcolor2label_query, vtype2label_query = self._process_dir(self.query_img_dir, self.query_heatmap_dir, self.query_segment_dir, self.query_label, relabel=False)
        gallery, num_gallery_vids, num_gallery_vcolors, num_gallery_vtypes, num_gallery_imgs, vcolor2label_gallery, vtype2label_gallery = self._process_dir(self.gallery_img_dir, self.gallery_heatmap_dir, self.gallery_segment_dir, self.gallery_label, relabel=False)

...
from torchvision.transforms import InterpolationMode  # 替代 _pil_interp
#from timm.data.auto_augment import RandomResizedCropAndInterpolation
from torchvision.transforms import ToTensor  # 替代 ToTensor
import numpy as np

...
if __name__=="__main__":
    ...
    parser.add_argument('--sdaa-log', type=str,default="/data/application/huangyun/mobilenetv3-master/sdaa1.log")
    parser.add_argument('--cuda-log', type=str,default="/data/application/huangyun/mobilenetv3-master/cuda.log")

...
def create_dataset(
  ...
  if name == 'market1501':
    im_dir = ospeu("/mnt/nvme1/application/huangyun/AlignedReID-Re-Production-Pytorch-master/images/")
    partition_file = ospeu("/mnt/nvme1/application/huangyun/AlignedReID-Re-Production-Pytorch-master/partitions.pkl")

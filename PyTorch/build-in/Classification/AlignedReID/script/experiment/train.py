...
# log_file_path = "/mnt/nvme1/application/huangyun/AlignedReID-Re-Production-Pytorch-master/2506101517_epoch300.log"
...
# sys.stdout = log_file  
# print("Logging started at", time.strftime("%Y-%m-%d %H:%M:%S"))

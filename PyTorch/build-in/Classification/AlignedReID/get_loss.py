...
if __name__=="__main__":
    ...
    parser.add_argument('--sdaa-log', type=str,default="/localnvme/application/huangyun/AlignedReID-Re-Production-Pytorch-master/12506101336_epoch300.log")
    parser.add_argument('--cuda-log', type=str,default="/localnvme/application/huangyun/AlignedReID-Re-Production-Pytorch-master/cuda.log")

...
if __name__=="__main__":
    ...
    parser.add_argument('--sdaa-log', type=str,default="/localnvme/application/huangyun/SiamTrackers-master/SiamFC/SiamFC/models/logs/train_sdaa_log.log")
    parser.add_argument('--cuda-log', type=str,default="/localnvme/application/huangyun/SiamTrackers-master/SiamFC/SiamFC/models/logs/train_cuda_log.log")

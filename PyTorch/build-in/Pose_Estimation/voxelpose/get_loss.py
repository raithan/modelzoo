...
def parse_string(string):
    pattern = r"Loss:\s+([+-]?\d+\.\d+)\s*(?![a-zA-Z_])"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--sdaa-log', type=str, default="/localnvme/application/huangyun/voxelpose/output/shelf_synthetic/multi_person_posenet_50/prn64_cpn80x80x20/prn64_cpn80x80x20_2025-07-16-06-50_train.log")
    parser.add_argument('--cuda-log', type=str, default="/localnvme/application/huangyun/voxelpose/output/shelf_synthetic/multi_person_posenet_50/prn64_cpn80x80x20/prn64_cpn80x80x20_2025-08-20-05-46_train.log")

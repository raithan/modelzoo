...
def main():
    ...
    # print("cfg.DATASET.TRAIN_DATASET =", cfg.DATASET.TRAIN_DATASET)
    train_dataset = eval('dataset.'+cfg.DATASET.TRAIN_DATASET)(
        ...
        cfg=cfg, image_dir="/mnt/nvme1/dataset/datasets/coco/images/train2017/", annotation_file="/mnt/nvme1/dataset/datasets/coco/annotations/person_keypoints_train2017.json", \
    ...
    valid_dataset = eval('dataset.'+cfg.DATASET.TEST_DATASET)(
        ...
        cfg=cfg, image_dir="/mnt/nvme1/dataset/datasets/coco/images/val2017/", annotation_file="/mnt/nvme1/dataset/datasets/coco/annotations/person_keypoints_val2017.json", \

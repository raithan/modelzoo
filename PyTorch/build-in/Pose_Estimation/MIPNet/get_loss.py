...
if __name__=="__main__":
    ...
    parser.add_argument('--sdaa-log', type=str,default="/localnvme/application/huangyun/MIPNet/tools/output/mpii/pose_hrnet/w48_384x288_adam_lr1e-3/sdaa.log")
    parser.add_argument('--cuda-log', type=str,default="/localnvme/application/huangyun/MIPNet/tools/output/mpii/pose_hrnet/w48_384x288_adam_lr1e-3/w48_384x288_adam_lr1e-3_2025-07-23-04-03_train.log")

...
class BSDS_RCFLoader(data.Dataset):
    ...
    def __init__(self, root='data/HED-BSDS_PASCAL', split='train', transform=False):
        self.root = '/mnt/nvme1/application/huangyun/rcf-edge-detection-master/data'
        self.split = split
        self.transform = transform
        self.bsds_root = join(root, 'HED-BSDS')
        if self.split == 'train':
            self.filelist = "/mnt/nvme1/application/huangyun/rcf-edge-detection-master/data/bsds_pascal_train_pair.lst"

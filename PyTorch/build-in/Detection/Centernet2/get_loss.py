...
def parse_string(string):
    pattern = r"total_loss:\s*([+-]?\d+\.?\d*|inf|-inf|nan)"
...
if __name__=="__main__":
    ...
    parser.add_argument('--sdaa-log', type=str,default="/localnvme/application/huangyun/Centernet/20250707.log")
    parser.add_argument('--cuda-log', type=str,default="/localnvme/application/huangyun/Centernet/cuda0708.log")

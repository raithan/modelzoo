...
def parse_string(string):
    ...
    pattern = r"Loss:(\d+\.?\d*|inf|-inf|nan)"
...
if __name__=="__main__":
    ...
    parser.add_argument('--sdaa-log', type=str,default="/localnvme/application/huangyun/Pyramidbox/20250619.log")
    parser.add_argument('--cuda-log', type=str,default="/localnvme/application/huangyun/Pyramidbox/cuda.log")

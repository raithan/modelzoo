...
taskset -c $PID_START-$PID_END python3 main.py ctdet --exp_id pascal_resdcn18_384 --arch resdcn_18 --device_list='0,1,2,3' --dataset pascal --num_epochs 90 --lr_step 45,60,75 --port='34578' --world_size 4  --batch_size $batch_size --lr 3.54e-4 --num_workers ${KERNEL_NUM} --local_rank $RANK_ID > ${test_path_dir}/output/${ASCEND_DEVICE_ID}/train_${ASCEND_DEVICE_ID}.log 2>&1 &
done

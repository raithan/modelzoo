...
def make_parser():
    ...
    parser.add_argument('--local_rank','--local-rank',type=int, default=0) # 添加 --local-rank
...
def main():
    ...
    torch.distributed.init_process_group(backend='tccl', init_method='env://') # 修改nccl 为tccl
    synchronize()

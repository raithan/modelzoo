...
num_classes = 1203
lvis_cat_frequency_info = '/data/teco-data/lvis/metadata/lvis_v1_train_cat_info.json'
 
# 'data/metadata/lvis_v1_clip_a+cname.npy' is pre-computed
# CLIP embeddings for each category
cls_layer = dict(
    type='ZeroShotClassifier',
    zs_weight_path='/data/teco-data/lvis/metadata/lvis_v1_clip_a+cname.npy',
    zs_weight_dim=512,
    use_bias=0.0,
    norm_weight=True,
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type='LVISV1Dataset',
            data_root='/data/teco-data/lvis/lvis/',
...
val_evaluator = dict(
    type='LVISMetric',
    ann_file='/data/teco-data/lvis/lvis/annotations/lvis_v1_val.json',
    metric=['bbox', 'segm'])

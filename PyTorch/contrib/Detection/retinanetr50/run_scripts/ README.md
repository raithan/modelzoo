...
参数名 | 解释 | 样例
-----------------|-----------------|-----------------
config | 配置文件。 | --config  ../configs/retinanet/retinanet_r50_fpn_1x_coco.py
cfg-options | 动态覆盖配置文件。 | --cfg-options train_dataloader.dataset.data_root=/data/teco-data/coco
work-dir | 工作目录。 | --work-dir ./run_scripts/work_dirs/retinanet_r50_fpn_1x_coco

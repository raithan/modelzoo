...
### 2.2 准备数据集
#### 2.2.1 获取数据集
BLIP使用 ImageNet 数据集，该数据集为开源数据集，可从 [coco](https://cocodataset.org/) 下载。
...
MeanRelativeError: -0.0065089704954821295
MeanAbsoluteError: -0.057550076210852896
Rule,mean_absolute_error -0.057550076210852896
pass mean_relative_error=-0.0065089704954821295 <= 0.05 or mean_absolute_error=-0.057550076210852896 <= 0.0002
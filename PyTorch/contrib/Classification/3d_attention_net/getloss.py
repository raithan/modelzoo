...
if __name__=="__main__":
    ...
    parser.add_argument('--sdaa-log', type=str,default="/localnvme/application/huangyun/Residual-Attention-Network/202506181400.log")
    parser.add_argument('--cuda-log', type=str,default="/localnvme/application/huangyun/Residual-Attention-Network/202506171433cuda.log")

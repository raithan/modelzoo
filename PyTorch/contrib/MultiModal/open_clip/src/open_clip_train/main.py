...
if not hasattr(torch.backends.cuda, 'is_built'):
    import importlib
    real_cuda_backend = importlib.import_module('torch.backends.cuda')
    torch.backends.cuda.is_built = real_cuda_backend.is_built
...
# 初始化SDAA设备
    ...
    if args.train_data or args.dataset_type == "synthetic":
        ...
        if args.precision == "amp":
            ...
            logging.info("Using SDAA AMP mixed precision training")

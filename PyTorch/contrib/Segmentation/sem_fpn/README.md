...
- 仓库链接：[https://github.com/open-mmlab/mmsegmentation/tree/main/configs/sem_fpn](https://github.com/open-mmlab/mmsegmentation/tree/main/configs/sem_fpn)
...
## 2.2 准备数据集
Sem_fpn使用Cityscapes数据集，该数据集为开源数据集，可从[CityScapes](https://www.cityscapes-dataset.com/login/)下载。
## 2.3 构建环境
...
2. 运行训练。该模型支持单机单卡。
   ```
   python run_sem_fpn.py --config ../configs/sem_fpn/fpn_r50_4xb2-80k_cityscapes-512x1024.py.py  \

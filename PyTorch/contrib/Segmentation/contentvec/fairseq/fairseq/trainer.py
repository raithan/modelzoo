        ...
        if self.is_fsdp and self.cfg.common.fp16:
            ...
            if self.cuda:
                try:
                    ...
                    if major_cc < 7:
                        logger.warning("Compute capability < 7, may not support optimizations")
                except NotImplementedError:
                    # SDAA backend does not support this
                    logger.warning("Skipping compute capability check for SDAA backend")

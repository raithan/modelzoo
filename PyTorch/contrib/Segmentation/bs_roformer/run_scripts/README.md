...
| 参数名                          | 说明                                                                                                     | 示例                                       |
| ---------------------------- | ------------------------------------------------------------------------------------------------------ | ---------------------------------------- |
| `--model_type`               | 指定模型类型，可选：`mdx23c`、`htdemucs`、`segm_models`、`mel_band_roformer`、`bs_roformer`、`swin_upernet`、`bandit`。 | `--model_type bs_roformer`               |
| `--config_path`              | 模型配置文件路径（YAML/JSON）。                                                                                   | `--config_path configs/bs_roformer.yaml` |

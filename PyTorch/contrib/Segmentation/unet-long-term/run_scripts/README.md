...
参数名 | 解释 | 样例
-----------------|-----------------|-----------------
config | 配置文件。 | --config  ../configs/unet/unet_s5-d16_deeplabv3_4xb4-40k_chase-db1-128x128.py
cfg-options | 动态覆盖配置文件。 | --cfg-options train_dataloader.dataset.data_root=xxx
work-dir | 工作目录。 | --work-dir ./work_dirs/unet_s5-d16_deeplabv3_4xb4-40k_chase-db1-128x128
